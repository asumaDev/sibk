<?php if(COUNT($this->session->userdata('username'))==0) { redirect();?>
		...
		<?php } else { ?>
			...
			<div class="main-container ace-save-state" id="main-container">
				...
				<div id="sidebar" class="sidebar responsive ace-save-state">
					...
					<div class="sidebar-shortcuts" id="sidebar-shortcuts" style="background-color: white">
						<div class="sidebar-shortcuts-large" id="sidebar-shortcuts-large">
							<img src="<?php echo base_url();?>assets/images/logo.png" style="width: 80%;padding: 10px">
						</div>

						<div class="sidebar-shortcuts-mini" id="sidebar-shortcuts-mini" style="background-color: white">
							<img src="<?php echo base_url();?>assets/images/logo.png" style="width: 100%;padding: 10px">
						</div>
		...
		<div class="footer-inner">
			<div class="footer-content">
				<span class="bigger-120">
					<span class="blue bolder">ASM</span>
					Development &copy; 2019
				</span>
			</div>
		</div>
	</div>
