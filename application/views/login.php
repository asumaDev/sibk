...
<head>
	...
	<title>Halaman Login - SI-BK</title>
					...
					<div class="login-container">
						<div class="center">
							<h1>
								...
								<span class="red">ASM</span>
								<span class="white" id="id-text2">Development</span>
							</h1>
							<h4 class="blue" id="id-company-text">&copy; SI UAD</h4>
						</div>
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<div class="social-or-login center">
											<span class="bigger-110">Madrasah Muallimin</span> </br>
											<span class="bigger-110">Muhammadiyah Yogyakarta</span>
										</div>
