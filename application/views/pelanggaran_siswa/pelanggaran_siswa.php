			...
			<div class="row">
				<div class="col-xs-12">
					<div class="widget-title">
						<h4><i class="icon-search"></i> Search Siswa <span class="badge tooltips" data-trigger="hover" data-placement="right" data-original-title="Pencarian data siswa berdasarkan NIS atau Nama Siswa" style="background-color: #4a8bc2;cursor: pointer;">?</span></h4>
					</div>
